...
import { getsammury, getlogtoday } from '../../api/progressApi';
...
const Home = () => {
  ...
  useEffect(() => {
    const fetchHomeSnapshotData = async () => {
      try {
    ...
    fetchHomeSnapshotData();
  }, []);


  // Local calculations copy-pasted from Dashboard logic
  ...
  return (
    <div className="home-page">
      ...
      <HomeSchedule
        ...
        goalsDone={goalsSummary.done || 0}
        goalsTotal={goalsSummary.total || 0}
