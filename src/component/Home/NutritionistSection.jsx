...
import NutritionistHomeCards from '../NutritionistCard/NutritionistHomeCards'
    ...
    <section className="nutritionist-section-wrapper">
      <div className="section-container">
        ...
        <div className="section-header">
          ...
          {showViewAll && (
            <Link to='/nutritionists' className="view-nutritionists-btn">
        ...
        <div className="nutritionists-grid" ref={scrollRef} onScroll={handleScroll}>
          {data.length > 0 ? (
            data.slice(0, limit).map((n) => (
              <NutritionistHomeCards key={n._id} nutritionist={n} isRecommended={isRecommended}/>
            ))
          ) : (
